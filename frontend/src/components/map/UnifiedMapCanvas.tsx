...
function UnifiedMapCanvas(props: ModernUnifiedMapCanvasProps) {
    ...
    const handleScreenshot = useCallback(async () => {
        const svgElement = document.getElementById('svgMap') as SVGSVGElement | null;
        if (!svgElement) {
        ...
        try {
            ...
            svgClone.setAttribute('style', `font-family: ${computedStyle.fontFamily}`);
            ...
            bgRect.setAttribute('fill', svgBackground === 'url(#wardleyGradient)' ? 'white' : svgBackground);
            ...
            img.onload = async () => {
                ...
                // Fill background
                ctx.fillStyle = svgBackground === 'url(#wardleyGradient)' ? 'white' : svgBackground;
